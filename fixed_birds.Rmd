...
No error expected in this code chunk: # I agree
...
## instead of pipe you can use $ to go to that column
...
# changed semi join to a full join to add park name column
